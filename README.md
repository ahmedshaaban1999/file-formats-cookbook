...
**[Recipe 1: Hello World - Writing Parquet with PyArrow vs FastParquet](file-formats/parquet/hello_world/hello_world.md)**
...
**[Recipe 2: Column Selection - Reading Only What You Need](file-formats/parquet/column_selection/column_section.md)**
...
**[Recipe 3: Metadata Inspection - Exploring Files Without Reading Data](file-formats/parquet/metadata_inspection/metadata_inspection.md)**
...
**[Recipe 4: Partitioning - Organizing Data for Query Optimization](file-formats/parquet/partitioning/partitioning.md)**
...
**[Recipe 5: Schema Evolution - Adding Columns Without Breaking Readers](file-formats/parquet/schema_evolution/schema_evolution.md)**
...
**[Recipe 6: Z-Ordering - Optimizing Multi-Dimensional Query Performance](file-formats/parquet/z_ordering/z_ordering.md)**
...
**[Recipe 1: Schema Definition - Defining Data Contracts in Avro](file-formats/avro/schema_definition/schema_definition.md)**
...
**[Recipe 2: Serialized Writing - Writing and Appending Records](file-formats/avro/serialized_writing/serialized_writing.md)**
...
**[Recipe 3: Schema Evolution - Evolving Schemas Without Breaking Consumers](file-formats/avro/schema_evolution/schema_evolution.md)**
...
**[Recipe 4: Compression Toggling - Choosing the Right Codec](file-formats/avro/compression_toggling/compression_toggling.md)**
...
**[Recipe 5: Fast Integration - Reading Avro Bytes Directly from Memory](file-formats/avro/fast_integration/fast_integration.md)**
